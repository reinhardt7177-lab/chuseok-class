...
export const SECTIONS = [
  {
    ...
    content: {
      ...
      mid: {
        headline: '일 년 중 가장 둥근 달이 뜨는 날',
        lines: [
          '가을 하늘에 커다랗고 둥근 보름달이 떠올랐습니다.',
          '일 년 중에 달이 가장 크고 밝게 보이는 밤이에요.',
          '이 무렵은 봄에 심은 곡식을 처음 거두는 때이기도 합니다.',
          '온 가족이 모여 거둔 것을 나누고 고마움을 전하는 날,',
          '그날이 바로 추석입니다.',
        ],
        keyword: '추석 · 한가위',
      },
      high: {
        ...
        lines: [
          '음력 8월 15일. 한 해 중 달이 가장 크고 둥글게 차오르는 밤입니다.',
    ...
    prompts: {
      ...
      high: [
        '왜 하필 "가장 둥근 달"이 뜨는 날을 명절로 정했을까요?',
...

  {
    ...
    content: {
      ...
      high: {
        ...
        lines: [
          ...
          '중국에는 중추절, 일본에는 오봉 등 비슷한 시기의 명절이 있습니다.',
          '모두 수확에 감사하고 조상을 기리는 농경 사회의 전통이라는 점이 같습니다.',
        ],
        facts: [
    ...
    prompts: {
      low: ['우리 가족은 추석에 누구를 만나나요?', '추석에 가면 누가 제일 반가운가요?'],
      mid: ['음력과 양력은 무엇이 다를까요?', '왜 추석 날짜는 해마다 바뀔까요?'],
      high: [
        '농사짓는 사회에서 음력을 쓴 까닭은 무엇일까요?',
        '여러 나라에 비슷한 시기의 명절이 있는 이유는 무엇일까요?',
      ],
    },
  },
    ...
    content: {
      ...
      mid: {
        ...
        lines: [
          ...
          '이 놀이를 가배라 불렀고, 그것이 오늘날의 추석이 되었다고 합니다.',
        ],
        facts: [
...

  {
    ...
    content: {
      ...
      mid: {
        headline: '올해 거둔 것으로 차리는 상',
        lines: [
          '추석 음식에는 공통점이 하나 있습니다.',
          '모두 올해 새로 거둔 것으로 만든다는 점이에요.',
...

  {
    ...
    content: {
      ...
      mid: {
        ...
        lines: [
          '추석 아침에는 조상께 음식을 올리고 인사드립니다.',
          '이것을 차례라고 해요.',
          '차례를 마친 뒤에는 산소를 찾아가 인사합니다. 성묘라고 하지요.',
          '추석 전에 미리 산소의 풀을 베어 정리하는 일은 벌초입니다.',
          '차례상에는 음식을 놓는 자리에 규칙이 있어요.',
          '붉은 과일은 동쪽, 흰 과일은 서쪽. 이것을 홍동백서라고 합니다.',
          '그런데 요즘은 집집마다 방식이 많이 다릅니다.',
        ...
        items: [
          ...
          { name: '홍동백서', emoji: '🍎', gloss: '붉은 과일은 동쪽, 흰 과일은 서쪽' },
        ],
        keyword: '차례 · 성묘 · 벌초',
      },
      high: {
        ...
        lines: [
          ...
          '상차림에는 오래된 규칙들이 전해집니다.',
          '홍동백서 — 붉은 과일은 동쪽, 흰 과일은 서쪽.',
          '조율이시 — 대추, 밤, 배, 감 순서로 놓기.',
          '어동육서 — 생선은 동쪽, 고기는 서쪽.',
          '그런데 이 규칙들은 문헌마다 다릅니다.',
          '집안마다 우리 집은 이렇게 한다는 가가례(家家禮)가 있었지요.',
          '2022년 성균관은 전을 올리지 않아도 된다는 표준안을 내놓기도 했습니다.',
          '중요한 것은 상의 모양보다 기억하고 고마워하는 마음이라는 뜻입니다.',
        ],
        items: [
          { name: '차례', emoji: '🕯️', gloss: '명절 아침의 간소한 제사' },
          { name: '성묘·벌초', emoji: '⛰️', gloss: '산소를 찾아 살피고 손질하는 일' },
          { name: '홍동백서', emoji: '🍎', gloss: '붉은 과일 동쪽, 흰 과일 서쪽' },
          { name: '조율이시', emoji: '🌰', gloss: '대추·밤·배·감 순으로 놓기' },
          { name: '어동육서', emoji: '🐟', gloss: '생선은 동쪽, 고기는 서쪽' },
    ...
    content: {
      ...
      high: {
        ...
        lines: [
          ...
          '가배가 그랬듯, 우리 민속놀이는 겨룬 뒤 다시 하나로 모이는 구조를 반복합니다.',
        ],
        items: [
...

  {
    ...
    content: {
      ...
      mid: {
        ...
        lines: [
          '예전에는 온 가족이 고향에 모여 며칠을 함께 보냈습니다.',
          '요즘은 모습이 많이 달라졌어요.',
